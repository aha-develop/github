...
export type GetPullRequestQuery = { __typename: 'Query', repository: { __typename: 'Repository', pullRequest: { __typename: 'PullRequest', id: string, number: number, title: string, url: any, state: PullRequestState, merged: boolean, reviewDecision: PullRequestReviewDecision | null, repository: { __typename: 'Repository', url: any }, headRef: { __typename: 'Ref', name: string } | null, commits: { __typename: 'PullRequestCommitConnection', nodes: Array<{ __typename: 'PullRequestCommit', commit: { __typename: 'Commit', statusCheckRollup: { __typename: 'StatusCheckRollup', state: StatusState } | null, status: { __typename: 'Status', contexts: Array<{ __typename: 'StatusContext', context: string, description: string | null, targetUrl: any | null, avatarUrl: any | null, state: StatusState }> } | null } } | null> | null }, latestReviews: { __typename: 'PullRequestReviewConnection', nodes: Array<{ __typename: 'PullRequestReview', state: PullRequestReviewState } | null> | null } | null, labels: { __typename: 'LabelConnection', nodes: Array<{ __typename: 'Label', color: string, name: string } | null> | null } | null } | null } | null };

export type PrForLinkFragment = { __typename: 'PullRequest', id: string, number: number, title: string, url: any, state: PullRequestState, merged: boolean, repository: { __typename: 'Repository', url: any }, headRef: { __typename: 'Ref', name: string } | null };
...
export type PrStatusesFragment = { __typename: 'PullRequest', commits: { __typename: 'PullRequestCommitConnection', nodes: Array<{ __typename: 'PullRequestCommit', commit: { __typename: 'Commit', statusCheckRollup: { __typename: 'StatusCheckRollup', state: StatusState } | null, status: { __typename: 'Status', contexts: Array<{ __typename: 'StatusContext', context: string, description: string | null, targetUrl: any | null, avatarUrl: any | null, state: StatusState }> } | null } } | null> | null } };
...
export const PrStatusesFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PrStatuses"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"PullRequest"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"commits"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"last"},"value":{"kind":"IntValue","value":"1"}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"commit"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"PrCommitStatus"}}]}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PrStatusContext"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"StatusContext"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"context"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"targetUrl"}},{"kind":"Field","name":{"kind":"Name","value":"avatarUrl"}},{"kind":"Field","name":{"kind":"Name","value":"state"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"PrCommitStatus"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Commit"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"statusCheckRollup"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"state"}}]}},{"kind":"Field","name":{"kind":"Name","value":"status"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"contexts"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"PrStatusContext"}}]}}]}}]}}]} as unknown as DocumentNode<PrStatusesFragment, unknown>;
